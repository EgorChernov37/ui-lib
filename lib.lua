...
local Utility = {}
local Objects = {}
function Nordic:DraggingEnabled(frame, parent)
...
function Nordic.CreateLib(kavName, themeList)
    ...
    Nordic:DraggingEnabled(MainHeader, Main)
    ...
    close.Image.ImageColor3 = Color3.fromRGB(255,255,255)
    ...
    function Nordic:ChangeColor(prope,color)
